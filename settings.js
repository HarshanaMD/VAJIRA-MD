...
global.owner = process.env.OWNER_NUMBER  || '94727898534' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=uYlTCaAA#vIPo8RBszt9VwfcN-NUKXm42RltWqF3pZ4b0X97K3g0' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '150': process.env.MAX_SIZE,/*add this in megabytes*/    
